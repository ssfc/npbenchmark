...
//读取文件数据，创建图
void create_graph() {
    ifstream infile("C:\\wamp64\\www\\npbenchmark\\npbenchmark-main\\SDK.GCP\\chenfeng_tabu\\data\\DSJC250.9.col.txt", ios::in);
    // ifstream infile("/home/ssfc/SDK.GCP/data/DSJC250.9.col.txt", ios::in);
    // ifstream infile("/home/ssfc/SDK.GCP/data/DSJC500.5.col.txt", ios::in); 
    vector<string> data;
    string delim(" ");
    string textline;
    bool start = false;
...
void tabusearch() {
    create_graph();
    int numofcolor = 13;
    ofstream ofile("C:\\wamp64\\www\\npbenchmark\\npbenchmark-main\\SDK.GCP\\chenfeng_tabu\\total_O3.txt", ios::out);
