...
class A_Star(object):
    # Q: 页面中函数__init__(self, input_map, input_start, input_goal, input_heuristics, input_agent, input_constraints)的功能是什么？
    # 初始化一个CBS对象，即一个用于解决多智能体路径规划问题的冲突检测搜索对象。
    # Q: 页面中函数__init__(self, input_map, input_start, input_goal, input_heuristics, input_agent, input_constraints)
    # 输入参数的数据类型和含义分别是什么？
    ...
    # 输出结果的数据类型和含义分别是什么？
    # @return (void)
    def __init__(self, input_map, input_start, input_goal, input_heuristics, input_agent, input_constraints):
        """my_map   - list of lists specifying obstacle positions
        input_start      - [(x1, y1), (x2, y2), ...] list of start locations for CBS
        input_goal       - [(x1, y1), (x2, y2), ...] list of goal locations for CBS
        input_agent      - the agent (CBS) or meta-agent of the agent (MA-CBS) involved in collision
