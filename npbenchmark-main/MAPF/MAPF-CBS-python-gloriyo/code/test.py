...
class CBSSolver(object):
    ...
    def find_solution(self, disjoint=True):
        ...
        def detect_cardinal(self, collision, p):
            ...
            alt_path1 = a_star(self.test_map, self.test_start[a1], self.test_goal[a1], self.heuristics[a1], a1, new_constraints)
            print(alt_path1)
            ...
            alt_path2 = a_star(self.test_map, self.test_start[a2], self.test_goal[a2], self.heuristics[a2], a2, new_constraints)
            print(alt_path2)
        ...
        def find_bypass(self, p, collision, collision_type):
            ...
            for i in range(len(temp)):
                ...
                alt_path = a_star(self.test_map, self.test_start[a_curr], self.test_goal[a_curr], self.heuristics[a_curr], a_curr, split)
                q = {'cost':0,
                    'constraints': [],
                    'paths':[],
                    'collisions':[]
                ...
                if disjoint and temp[i]['agent'] == ('a'+str(i+1)):
                    if temp[i]['positive']:
                        ...
                        for v in vol:
                            path_v = a_star(self.test_map, self.test_start[v], self.test_goal[v], self.heuristics[v], v, q['constraints'])
                            if path_v  is None :
                                continue_flag = True
                            else:
