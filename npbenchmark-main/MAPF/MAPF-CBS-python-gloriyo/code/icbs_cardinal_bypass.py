...
class ICBS_CB_Solver(object):
    ...
    def find_solution(self, disjoint):
        ...
        def detect_cardinal_conflict(self, p, collision):
            ...
            alt_path1 = a_star(self.test_map, self.test_start[a1], self.test_goal[a1], self.heuristics[a1], a1, temp_constraints)
            print(alt_path1)
            ...
            alt_path2 = a_star(self.test_map, self.test_start[a2], self.test_goal[a2], self.heuristics[a2], a2, temp_constraints)
            print(alt_path2)
        ...
        def detect_cardinality(self, disjoint, p, collision, nc):
            ...
            if disjoint:
                ...
                alt_path_chosen = a_star(self.test_map, self.test_start[chosen_agent], self.test_goal[chosen_agent], self.heuristics[chosen_agent], chosen_agent, all_constraints_pos)
                ...
                for v in alt_path_vols:
                    path_v = a_star(self.test_map, self.test_start[v], self.test_goal[v], self.heuristics[v], v, all_constraints_pos)
                    if path_v  is None :
                        path_failed = True
                        break
                    else:
                ...
                alt_path_chosen = a_star(self.test_map, self.test_start[chosen_agent], self.test_goal[chosen_agent], self.heuristics[chosen_agent], chosen_agent, all_constraints_neg)
                # new_paths = copy.deepcopy(p['paths'])
                # new_paths[chosen_agent] = copy.deepcopy(alt_path_chosen)
